                ...
                if ($image_size) {
                    ...
                    switch ($this->file_path) {
                        ...
                        case UPLOAD_AVATOR:
                            ...
                            // 用户头像
                            $new_key = $this->reset_file_path . md5(time() . $name) . "_120_120" . $ext;
                        ...
                        case UPLOAD_COMMENT:
                            ...
                            // 评论
                            $new_key = $this->reset_file_path . md5(time() . $name) . "_600_600" . $ext;
    ...
    private function validationFile()
    {
        ...
        switch ($this->file_path) {
            ...
            case UPLOAD_COMMENT:
                ...
                // 评论
                if (($this->file_type != "image/gif" && $this->file_type != "image/png" && $this->file_type != "image/jpeg" && $this->file_type != "image/jpg")) {

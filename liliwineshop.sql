...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品足迹表';
...
CREATE TABLE `ns_goods_category_block` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=8192 COMMENT='商品分类楼层表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=4096 COMMENT='虚拟商品分组表';
...
CREATE TABLE `sys_config` (
  ...
  `modify_time` int(11) DEFAULT '0' COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=140 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=963 COMMENT='第三方配置表';
...
) ENGINE=InnoDB AUTO_INCREMENT=10140 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=606 COMMENT='系统模块表';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('2', '0', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '', '1', '1', '', '0', '', '', '', '', '0', null, '0', null, null, '127.0.0.1', '1', '127.0.0.1', '1', '2', '', '0', '', 'admin', '', '0', '0', '0', '2018', '1537512751', '1537512427', '0');
...
CREATE TABLE `sys_user_log` (
  ...
  `create_time` int(11) DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=82 COMMENT='用户操作日志';

-- ----------------------------
-- Records of sys_user_log
-- ----------------------------
INSERT INTO `sys_user_log` VALUES ('1', '2', 'admin', '1', 'http://test.lili.com/index.php?s=/admin/login/login', '用户', '用户登录', '', '127.0.0.1', '1537512427');
